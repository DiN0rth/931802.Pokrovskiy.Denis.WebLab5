...
namespace WebLab5.Controllers
{
    public class LabsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address")] Labs labModel)
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (labModel == null) return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address")] Labs labModel)
        {
            if (id != labModel.Id) return NotFound();
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var labModel = await cntx.Labs.FirstOrDefaultAsync(m => m.Id == id);
            if (labModel == null) return NotFound();
