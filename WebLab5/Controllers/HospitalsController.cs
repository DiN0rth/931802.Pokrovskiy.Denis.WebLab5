...
namespace WebLab5.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phones")] Hospitals hospitalModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phones")] Hospitals hospitalModel)
        {
